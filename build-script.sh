...
INTERFACEVIEW=aruco_marker_detection_iv.aadl
grep "version => \"2" aruco_marker_detection_iv.aadl >/dev/null && {
    echo -e "${INFO} Converting interface view from V2 to V1.3"
    TASTE --load-interface-view aruco_marker_detection_iv.aadl --export-interface-view-to-1_3 __iv_1_3.aadl
